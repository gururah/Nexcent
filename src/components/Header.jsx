    ...
    <Box onClick={handleDrawerToggle} sx={{ textAlign: 'center' }}>
     <List>
        {['Home', 'Service', 'Feature', 'Product', 'Testimonial', 'FAQ'].map((text) => (
          <ListItem button key={text} sx={{ marginY: 1 }}> {/* Adjust marginY for vertical spacing */}
  ...
  return (
    <>
      <CustomAppBar position="static">
        <Toolbar>
          <Grid container alignItems="center" justifyContent="space-between" shadow='0'>
           
            <Grid item xs={2} sx={{ display: { xs: 'block', md: 'none' }, justifyContent: 'flex-start' }}>
            ...
            <Grid item xs={3} md={1} sx={{ display: { xs: 'none', md: 'flex' }}} marginRight={4}>
              <CustomButton color="inherit">Login</CustomButton>
